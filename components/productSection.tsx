...
const productlist = [
  {
    ...
    description:
      "Do you need funds but don't want to sell your crypto and miss out? Hing ...",
    content:
  ...
  
  {
    ...
    description:
      "On Hinges p2p exchange, frictionless local peer-to-peer trading allows ...",
    content:
...

  {
    ...
    description:
      "Hinges is a blockchain platform that allows you to easily co-invest in real estate ...",
    content:
  ...
  },
  {
    ...
    description:
      "Explore, Play, and Own land. Once you own it, place resources on it and ...",
    content:
  ...
  },
  {
    ...
    description:
      "Hinges Ventures is committed to becoming a global accelerator and...",
    content:
  ...
  },
  {
    ...
    description:
      "Our AI-driven technology lets us easily digest the relevant details and ...",
    content:
